...
<html lang="pt-br">
  ...
  <body class="bg-slate-200 font-Poppins dark:bg-dark-bg">
    ...
    <main>
      ...
      <div
        class="flex flex-col justify-center items-center bg-gray-100 shadow-lg mx-auto w-4/5 p-3 gap-3 rounded-md mb-10 sm:w-1/2 dark:bg-dark-container"
      >
        <figure>
          <img
            class="mt-5 mx-auto"
            src="../assets/img/status-1.png"
            alt="barra de estagio 1"
          />
        </figure>
        ...
        >
          <fieldset class="flex flex-col gap-2 w-3/4">
            ...
            <input
              ...
              name="nome"
              type="text"
              placeholder="Ex: Hemiliano da Silva Figueiredo"
          ...
          <div
            class="flex flex-col gap-2 w-3/4 lg:flex-row lg:gap-20 xl:gap-32"
          >
            <fieldset class="flex flex-col xl:w-3/4 gap-2">
              <label class="font-medium text-md" for="nascinemnto"
                >Nascimento</label
              >
              <input
                class="border border-blue-500 border-[1] rounded-md py-1 px-2 ml-2 dark:border-dark-input-border dark:bg-dark-input-bg"
                id="nascimento"
                name="nascimento"
                type="date"
                required
            ...
            <fieldset
              class="flex flex-col items-start gap-2 xl:w-3/4 2xl:items-center"
            >
              <legend class="font-medium text-md">Sexo</legend>
              <div
                class="flex flex-col gap-2 self-start flex-wrap ml-2 mt-2 2xl:flex-row"
              >
                ...
                <div class="flex gap-1">
                  <input
                    ...
                    required
                  />
                  <label class="font-normal" for="prefiro_nao_responder"
          ...
          <fieldset class="flex flex-col gap-2 w-3/4">
            <label class="font-medium text-md" for="nome_materno"
              >Nome Materno</label
            >
            <input
              class="border border-blue-500 border-[1] rounded-md w-full py-1 px-2 ml-2 dark:border-dark-input-border dark:bg-dark-input-bg"
          ...
          <fieldset class="flex flex-col gap-2 w-3/4">
            ...
            <input
              class="mask border border-blue-500 border-[1] rounded-md w-full py-1 px-2 ml-2 dark:border-dark-input-border dark:bg-dark-input-bg"
              minlength="11"
              id="cpf"
              name="cpf"
              type="text"
          ...
          <fieldset class="flex flex-col gap-2 w-3/4">
            <label class="font-medium text-md" for="confirma_senha"
          ...
          <div>
            <button
              id="enviar-btn"
              class="text-white font-normal bg-blue-500 rounded-md p-3 w-40 my-4 hover:bg-blue-800 duration-150 dark:bg-dark-btn-azul dark:hover:bg-dark-btn-azul-hover"
              type="submit"
            >
              Avançar
            </button>
