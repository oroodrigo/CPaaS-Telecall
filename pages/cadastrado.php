...
<body class="h-screen flex flex-col bg-slate-200 font-Poppins dark:bg-dark-bg">
  ...
  <main class="flex-1 flex flex-col">
    ...
    <div class="bg-gray-100 shadow-lg mx-auto w-1/2 p-3 rounded-md mb-24 mt-auto dark:bg-dark-container">
      <figure>
        <img class="my-5 mx-auto" src="../assets/img/status-3.png" alt="barra de estagio 3" />
      </figure>
      ...
      <a href="./login.php" class="block mx-auto text-center text-white bg-blue-500 rounded-md p-3 w-4/5 my-12 hover:bg-blue-800 duration-150 md:w-1/3 dark:bg-dark-btn-azul dark:hover:bg-dark-btn-azul-hover">
        Login
