  ...
  <main>
    <article class="flex flex-col gap-10 m-5 p-3">
      <section class="flex justify-around py-6 w-full">
        <section class="flex flex-col items-center justify-center gap-5 text-center w-full md:w-1/2 px-5">
          <h1 class="text-3xl text-telecall-azul-hover font-bold text-center dark:text-dark-title">
            Número Máscara
          </h1>
      ...
      <section class="flex flex-col gap-7 px-4 w-full mt-5">
        <h2 class="text-3xl text-telecall-azul font-bold titulo relative w-1/5 dark:text-dark-text">
          Como funciona?
        </h2>
        <section class="flex mt-5">
          <figure class="w-1/2 hidden md:flex justify-center">
            <img class="max-w-[400px]" src="../assets/img/numero-mascara/numero-mascara.png" alt="desenho de celular para simbolizar segurança" />
          </figure>
      ...
      <section class="flex flex-col gap-7 px-4 w-full mt-5">
        ...
        <section>
          <ul class="flex flex-col sm:flex-row flex-wrap gap-10 px-4 sm:justify-evenly sm:gap-2">
            <li class="flex flex-col items-center gap-2">
              ...
              <figure>
                <img class="max-w-[100px]" src="../assets/img/icons/99.png" alt="icone do app 99" />
              </figure>
            </li>
            <li class="flex flex-col items-center gap-2">
              ...
              <figure>
                <img src="../assets/img/icons/happn.png" alt="icone do app happn.png" />
              </figure>
              <figure>
                <img src="../assets/img/icons/tinder.png" alt="icone do app tinder.png" />
              </figure>
            </li>
            ...
            <li class="flex flex-col items-center gap-2">
              ...
              <figure>
                <img class="max-w-[100px]" src="../assets/img/icons/ebay.png" alt="icone do app ebay.png" />
              </figure>
            </li>
            <li class="flex flex-col items-center gap-2">
