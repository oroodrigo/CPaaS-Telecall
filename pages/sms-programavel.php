    ...
    <article class="flex flex-col gap-10 my-5 p-3">
      <section class="flex justify-around py-6 w-full">
        ...
        <figure class="w-1/2 hidden md:flex justify-center">
          <img class="max-w-[300px]" src="../assets/img/sms-programavel/undraw_personal_email_re_4lx7.svg  " alt="" />
        </figure>
      </section>
      ...
      <section class="flex flex-col gap-7 px-7 w-full mt-5">
        ...
        <section class="flex mt-5">
          <figure class="w-1/2 hidden md:flex justify-center">
            <img class="max-w-[350px]" src="../assets/img/sms-programavel/undraw_messages_re_qy9x.svg" alt="imagem para simbolizar segurança" />
          </figure>
      ...
      <section class="flex flex-col gap-7 px-4 w-full mt-5">
        <h2 class="text-3xl text-telecall-azul font-bold w-full pl-3 dark:text-dark-title">
          Como funciona?
        </h2>
        <section class="flex mt-5">
          ...
          <figure class="w-1/2 hidden md:flex justify-center ml-3 md:ml-5">
            <img class="max-w-[300px]" src="../assets/img/sms-programavel/undraw_online_groceries_a02y.svg" alt="imagem para simbolizar segurança" />
          </figure>
        </section>
      </section>
    </article>
